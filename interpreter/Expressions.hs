...
eval (Nat  x _) (Addition _) (Text y p)  = Text ((show x) ++ y) p
eval (Int  x _) (Addition _) (Text y p)  = Text ((show x) ++ y) p
eval (Real x _) (Addition _) (Text y p)  = Text ((show x) ++ y) p
eval (Bool x _) (Addition _) (Text y p)  = Text ((show x) ++ y) p
